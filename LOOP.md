...
## Aktueller Stand (It. 91, 15.07.26, Commit-Stand siehe HISTORY)
1627 Seiten live auf promptgarten.com: 61 Kapitel ×5 (ALLE mit 🌱/🔬, Quiz, Übungen), 236 Befehle ×5 auf 4 Plattformen (Claude Code/Codex/Cursor/Aider), 12 Addons ×5 mit Detailseiten, 4 Welten (W1=9, W2=13, W3=16), Benchmarks, Vergleiche, Loop-Galerie mit Video, Feed (22 News), 45 Remotion-Clips (6 Befehls-Demos + 42s-Flaggschiff-Explainer prominent auf Landing), Forum (leer, bereit), freie API, Admin V2 mit Unique-Besuchern (Tages-Hash) + Internal-Filter (Marvin/Loop/Bots raus, ?ich=1-Opt-out), Landing komplett, Wizard mit 4 Fragen + Tool-Empfehlung. Link-Audit #3: 212 URLs, 211 grün. Traffic: views_7d ~175, besucher_7d zählt ab 14.07.
