...
## Aktueller Stand (It. 94, 14.07.26 nachmittags, Commit-Stand siehe HISTORY)
1677 Seiten live auf promptgarten.com: 71 Kapitel ×5 (ALLE mit 🌱/🔬, Quiz, Übungen), 236 Befehle ×5 auf 4 Plattformen (Claude Code/Codex/Cursor/Aider), 12 Addons ×5 mit Detailseiten, 4 Welten (W1=9, W2=14, W3=18), Benchmarks, Vergleiche, Loop-Galerie mit Video, Feed (22 News), 45 Remotion-Clips (6 Befehls-Demos + 42s-Flaggschiff-Explainer prominent auf Landing), Forum (leer, bereit), freie API, Admin V2 mit Unique-Besuchern (Tages-Hash) + Internal-Filter (Marvin/Loop/Bots raus, ?ich=1-Opt-out), Landing komplett, Wizard mit 4 Fragen + Tool-Empfehlung. Link-Audit #3: 212 URLs, 211 grün. Traffic: views_7d ~224, besucher_7d zählt ab 14.07.
