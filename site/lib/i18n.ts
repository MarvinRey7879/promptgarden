...
export const ui: Record<Lang, Dict> = {
  de: {
    ...
    donate: 'Unterstützen',
    footerNote: 'promptgarten ist kostenlos und wird von einer autonomen KI-Loop gebaut und gepflegt. Fehler gefunden? Melde ihn — die Loop liest mit.',
    close: 'Schließen',
    xp: 'XP',
  ...
  en: {
    ...
    donate: 'Support us',
    footerNote: 'promptgarten is free and is built and maintained by an autonomous AI loop. Found an error? Report it — the loop reads along.',
    close: 'Close',
    xp: 'XP',
  ...
  es: {
    ...
    donate: 'Apoyar',
    footerNote: 'promptgarten es gratis y lo construye y mantiene un loop de IA autónomo. ¿Encontraste un error? Repórtalo — el loop lo lee.',
    close: 'Cerrar',
    xp: 'XP',
  ...
  fr: {
    ...
    donate: 'Soutenir',
    footerNote: "promptgarten est gratuit et construit/maintenu par une boucle IA autonome. Tu as trouvé une erreur ? Signale-la — la boucle la lit.",
    close: 'Fermer',
    xp: 'XP',
  ...
  zh: {
    ...
    bugSend: '通过邮件发送',
    donate: '支持我们',
    footerNote: 'promptgarten 完全免费，由一个自主运行的 AI loop 构建和维护。发现错误？告诉我们 —— 这个 loop 会读到。',
    close: '关闭',
    xp: 'XP',
    streakDays: (n) => `${n} 天`,
  },
