...
export const ui: Record<Lang, Dict> = {
  ...
  fr: {
    ...
    cards: [
      ...
      { emoji: '🔄', title: 'Loops', desc: 'Réfléchir → agir → vérifier. Et on recommence.', href: 'lexikon/loops-fuer-agenten/' },
    ],
    insightLabel: 'INSIGHT DE LA SEMAINE',
  ...
  zh: {
    ...
    cards: [
      ...
      { emoji: '🔄', title: 'Loop', desc: '思考 → 行动 → 检查。然后从头再来。', href: 'lexikon/loops-fuer-agenten/' },
    ],
    insightLabel: '本周洞察',
